...
% -----------------------------------------------------------------------------
% Poster body: full-width horizontal bands with two-column interiors
% -----------------------------------------------------------------------------
% Band 1: 3DGS and modal-analysis background.
\noindent
...
% Band 2: the asynchronous setting spans the full poster width.
...
% Band 3: the shared 3D solve spans the full poster width.
