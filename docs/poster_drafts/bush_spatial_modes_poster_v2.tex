...
\newcommand{\postersubsection}[1]{%
  \vspace{0.10in}
  {\bfseries\color{PosterInk}\fontsize{26}{31}\selectfont #1\par}
  \vspace{0.03in}
}
    ...
    \IfFileExists{#1}{%
      ...
      \fcolorbox{PosterLine}{PosterFog}{%
        \parbox[c][#2][c]{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}{%
          \centering
          {\bfseries\fontsize{21}{25}\selectfont Figure placeholder}\par
          \vspace{0.10in}
          {\fontsize{17}{20}\selectfont\texttt{\detokenize{#1}}}}}}
    \vspace{0.05in}
    {\color{PosterMuted}\fontsize{17}{20}\selectfont #3\par}
  \end{center}
  \vspace{0.06in}
}
...
% -----------------------------------------------------------------------------
\begin{adjustbox}{max totalsize={\textwidth}{32.70in},center}
...
\postersection{4.}{Our reconstruction pipeline}{PosterSlate}
...
\posterplaceholder{../poster_brief/figures/bush_capture_and_cameras.png}{1.82in}{%
...
\postersection{3B.}{Synchronizing phase without synchronized time}{PosterClay}
